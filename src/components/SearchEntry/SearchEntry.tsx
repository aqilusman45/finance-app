...
const keys = ["Invoice ID", "product ID", "Name","Phone", "Payment", "Remaining"];
      ...
      <IonGrid className="ion-padding">
        <IonRow>
          ...
          <IonCol size="2" >
             ...
             <IonButton onClick={() => push('/home/add-entry')} className="btnStyle" color="primary">Add Entry</IonButton>
          </IonCol>
        </IonRow>
